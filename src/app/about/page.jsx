  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      <p>
        ...
        and trailes. Our movie database is constantly updated with new releases,
        ensuring that you have access to the latest and gratest in the world of
        cinema. Youcan search for movies by title, director, actor, genre, or
        release date, making easy to find the perfect movie for any occasion.
      </p>
      <p>
        ...
        rating for others users. We also have a section dedicated to movie news
        and trailes, keeping you updated with the latest happenings in the world
        of cinema. Thank you for visiting our website and we hope you enjoy your
